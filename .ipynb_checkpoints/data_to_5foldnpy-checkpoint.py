...
# Path configuration
nii_path = "data/centreline_set/coronal/img"
gt_path = "data/centreline_set/coronal/seg"
centreline_path = "data/centreline_set/coronal/centreline"
generated_centreilne_path = "data/centreline_set/coronal/centreline_single"
npy_path = "data/centreline_set/coronal/npy2023_5_folds"
...
for fold in range(num_folds):
    ...
    os.makedirs(os.path.join(npy_path, f"fold_{fold}", "centreline_single"), exist_ok=True)
    ...
    for name in tqdm(names_in_fold):
        ...
        if len(z_index) > 0:
            ...
            for i in z_index:
                ...
                np.save(os.path.join(fold_path, "centreline_single", f"{name.replace(gt_name_suffix, '')}_{str(i).zfill(3)}.npy"), generated_cenreline_points_roi)
